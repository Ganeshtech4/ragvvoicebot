      ...
      >
        ...
        <PromptInputFooter className="px-3 pb-3">
          <PromptInputTools>
            ...
            {onVoiceToggle && (
              <Button
                className="h-7 w-7 rounded-lg border border-border/40 p-1 transition-colors text-muted-foreground hover:border-border hover:text-foreground"
                onClick={(e) => {
                  e.preventDefault();
                  onVoiceToggle();
                }}
...
export const MultimodalInput = memo(
  ...
  (prevProps, nextProps) => {
    ...
    if (prevProps.onVoiceToggle !== nextProps.onVoiceToggle) {
      return false;
    }
